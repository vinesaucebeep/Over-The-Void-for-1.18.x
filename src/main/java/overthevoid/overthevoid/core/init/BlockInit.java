...
public class BlockInit {
    ...
    public static final RegistryObject<Block> POTTED_EERIE_ROOTS = BLOCKS.register("potted_eerie_roots", () -> new FlowerPotBlock(null, EERIE_ROOTS, BlockBehaviour.Properties.copy(Blocks.POTTED_CRIMSON_ROOTS).requiresCorrectToolForDrops()));
